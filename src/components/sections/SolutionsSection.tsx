...
const SolutionsSection = () => {
  ...
  return (
    <section
      ...
      className="min-h-screen bg-[#F5F9FC] dark:bg-[#091D2C] text-[#013762] dark:text-[#E7F2F7] md:snap-start"
    >
      <div className="mx-auto max-w-7xl px-4 pb-14 pt-24 sm:px-6 md:pb-16 lg:pl-8 lg:pr-16">
        <div className="flex flex-col gap-6 border-b border-[#013762]/15 dark:border-[#B4DDE7]/20 pb-7 md:flex-row md:items-end md:justify-between md:gap-12">
        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-[minmax(0,1.14fr)_minmax(0,0.86fr)] lg:gap-6">
          <TransitionLink
            ...
            className="group flex min-w-0 flex-col overflow-hidden rounded-2xl border border-[#013762]/12 dark:border-[#B4DDE7]/15 bg-white dark:bg-[#123149] transition-colors hover:border-[#0179B1]/55 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#0179B1] lg:grid lg:h-[22.5rem] lg:grid-cols-[42%_58%]"
          >
            <div className="overflow-hidden bg-[#E5F2F8] dark:bg-[#12374A]">
              <img
            ...
            {more.map((insight) => {
              ...
              return (
                <TransitionLink
                  ...
                  className="group grid min-h-0 flex-1 grid-cols-[minmax(0,1fr)_6.5rem] overflow-hidden rounded-2xl border border-[#013762]/12 dark:border-[#B4DDE7]/15 bg-white dark:bg-[#123149] transition-colors hover:border-[#0179B1]/55 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#0179B1] sm:grid-cols-[minmax(0,1fr)_9rem]"
                >
                  <div className="flex min-w-0 flex-col justify-between gap-4 p-5 sm:p-6">
                    ...
                    <div className="flex items-center justify-between gap-3 text-xs text-[#004C7A]/80 dark:text-[#A1D7E0]">
                      ...
                      <ArrowUpRight className="h-4 w-4 shrink-0 text-[#0179B1] dark:text-[#72D5E3]" aria-hidden="true" />
                    </div>
                  </div>
                  <div className="overflow-hidden bg-[#E5F2F8] dark:bg-[#12374A]">
                    <img

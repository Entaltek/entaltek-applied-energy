...
export const agentInsights: Insight[] = [
  {
    ...
    relatedSlugs: ["linear-proyectos-tareas-y-agentes", "mcp-conectar-herramientas-con-control"],
  ...
  },
  {
    ...
    relatedSlugs: ["hermes-agent-perfiles-y-subagentes", "mcp-conectar-herramientas-con-control"],
    ...
    sections: [
      ...
      { heading: "Empieza con el flujo manual", paragraphs: ["Abre un proyecto de prueba y dos issues con datos ficticios. Añade la relación de bloqueo y revisa que cada entrega se encuentre desde el issue. Luego compara los estados con lo que de verdad ocurrió. Esta prueba enseña qué información necesita tu equipo antes de conectar otras herramientas.", "Linear ofrece agentes instalables, servidor MCP y API para integraciones. La documentación de MCP distingue acceso de lectura y de escritura: la ruta de solo lectura permite una primera consulta sin exponer herramientas de cambio. Compara ID, título y estado de un issue conocido con la interfaz antes de ampliar permisos.", "Las capacidades y permisos deben comprobarse en la cuenta concreta. Estos ejemplos son ilustrativos: no muestran un agente de Hermes instalado como agente de Linear ni una sincronización entre sus tableros. Si quieres ordenar una tarea propia, podemos revisar primero qué debe documentarse para que cualquiera pueda retomarla."] },
    ],
  },
  {
